      ...
      <section className="flex flex-wrap mt-8">
        <div className="w-full md:w-1/2">
          ...
          <h2 className="font-regular text-xl mb-8 md:pr-8">
            ...
            shows e eventos, amplie sua visibilidade e alcance novos fãs. Nossa
            plataforma oferece as ferramentas necessárias para impulsionar sua
            carreira artística e expandir suas conexões no mundo da música.
          </h2>
        </div>
