      ...
      <section className="flex flex-wrap mt-8">
        <div className="w-full md:w-1/2">
          ...
          <h2 className="font-regular text-xl mb-8 md:pr-8">
            Abra as portas para uma variedade de talentos musicais ao criar uma
            conta em nossa plataforma. Encontre a combinação perfeita para os
            eventos que você planeja e ofereça experiências musicais únicas aos
            seus clientes.
          </h2>
        </div>
